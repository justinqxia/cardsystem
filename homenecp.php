...
<tr><td style="text-align:left;"><select name="destination" onchange='destinationselect(this.value);' required> 
    ...
    <option value="North_Dinning" >North</option>
...
<tr><td style="text-align:left;"><label for="return1">Excpected leaving time:</label>
...
<tr><td style="text-align:left;"><p>Click sumbit to finish</p></td></tr>
