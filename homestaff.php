...
<table border=2 cellpadding=10 cellspacing=15><tr><td>Student Name</td><td>ID Number</td><td>Email</td><td>Destination</td><td>Excepted Return Time</td><td>Companion</td><td>SP</td><td>Status</td></tr>
<?php
...
if ($result->num_rows > 0) {
  ...
  echo "<p style='font-size:30px;'>No one is currently signed out.</p>";
}
$conn->close();
?></table>
		</div>
